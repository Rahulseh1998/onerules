...
export function getBaseRules(): RuleSet {
  return {
    ...
    codingPatterns: [
      ...
      "Default to writing NO comments. The code should be self-documenting. Only comment the WHY when it would surprise a reader.",
    ...
    doNot: [
      ...
      "DO NOT rename or reorganize existing code that works. A bug fix is not an invitation to refactor the module.",
    ...
    testing: [
      ...
      "No mocks unless the real thing is slow, flaky, or has side effects (network, database, filesystem). Mocking everything produces tests that test nothing.",
